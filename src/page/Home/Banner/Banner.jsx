const Banner = () => {
  return (
    <div className="bg-[url('./assets/banner1.png')] lg:bg-[url('./assets/banner.png')] bg-cover lg:bg-contain w-full bg-no-repeat  lg:h-[800px]">
      <div className="lg:w-4/5 2xl:h-[700px] lg:h-[500px] h-[300px] mx-auto  flex  items-center ">
